...
import { fetchChartData } from '../Action/chartActions';
import {
  LineChart,
  Line,
  BarChart,
      ...
      case 'line':
        return (
          <LineChart data={chartData}>
            ...
            <Tooltip />
            <Legend />
            <Line type="monotone" dataKey="price" stroke="rgb(255,69,0)" activeDot={{ r: 8 }} />
          </LineChart>
        );
      ...
      case 'bar':
        return (
          <BarChart data={chartData}>
            ...
            <Tooltip />
            <Legend />
            <Bar dataKey="price" fill="rgb(0,191,255)" />
          </BarChart>
        );
      ...
      case 'area':
        return (
          <AreaChart data={chartData}>
            ...
            <Tooltip />
            <Legend />
            <Area type="monotone" dataKey="price" fill="rgb(0,255,0)" />
          </AreaChart>
        );
        ...
        <div className="md:flex sm:cols-2 sm:gap-10">
          <div className="pt-4 ml-20">
            {timeIntervals.map((interval) => (
              <button
                ...
                className={`ring-1 ring-yellow-600 bg-gray-100 px-4 py-1 rounded-md mx-3 mr-2 pb-1.5 ${
                  timeInterval === interval.value ? 'bg-blue-500 text-blue-700' : 'text-blue-700'
                }`}
              >
                {interval.label}
              </button>
          ...
          <div className="sm:col-span-2 flex justify-center right-24 gap-2 my-4 align-sub">
            <select
              ...
              className="ring-1 ring-yellow-600 bg-gray-100  text-blue-700 rounded focus:outline-none font-semibold"
            >
            ...
            <select
              className="ring-1 ring-yellow-700 bg-gray-100 text-blue-700 rounded focus:outline-none px-2 py-2 font-semibold"
              value={chartType}
